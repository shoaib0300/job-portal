...
<head>
  ...
  <link rel="stylesheet" href="/assets/css/app.css?v=20260804h">
  <link rel="stylesheet" href="/assets/css/resume-themes.css?v=20260804i">
...
function layout_footer(bool $withJs = true): void
{
  ...
  <?php if ($withJs): ?>
  <script src="/assets/js/app.js?v=20260804f"></script>
  <?php endif; ?>
</body>
</html>
<?php
